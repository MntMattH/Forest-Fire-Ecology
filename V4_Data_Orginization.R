...
dfPF<- data.frame(year=seq(1985,2020,1), range= c(rep("1985_1989", 5),rep("1990_1994", 5), rep("1995_1999", 5), rep("2000_2004",5), rep("2005_2009", 5), rep("2010_2014", 5), rep("2015_2020", 6)))
